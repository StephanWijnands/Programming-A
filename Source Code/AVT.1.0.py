...
class GuiAVT(tk.Frame):
    def __init__(self, root):
        ...
        self.avt_frame = tk.Frame(self.canvas)
...
class StartScreen(tk.Frame):
    def __init__(self, root):
        ...
        self.top_frame.grid(row=0, column=0, sticky=tk.N+tk.E+tk.W)
        self.top_frame.grid_columnconfigure(0, weight=1)
        self.top_frame.grid_rowconfigure(0, weight=1)

        self.button_frame = tk.Frame(root, background='yellow')
        self.button_frame.grid(row=1, column=0, pady=30)
        self.button_frame.grid_columnconfigure(0, weight=1)
    ...
    def show(self):
        welkom = tk.Label(self.top_frame, text="Welkom bij NS", bg="yellow", font=("Helvetica", 20), fg="blue", anchor='center')
        welkom.grid(row=0, column=0, pady=20, sticky=tk.NSEW)

        huidige_button = tk.Button(self.button_frame, text="Huidige Trajecten", fg="white", bg="blue",
                                   font=("Helvetica", 12), width=30, height=5, command=self.show_huidige)
        ...
        andere_button = tk.Button(self.button_frame, text="Ander Traject", fg="white", bg="blue",
                                  font=("Helvetica", 12), width=30, height=5, command=self.search_andere)
        andere_button.grid(row=0, column=1, pady=20, padx=50)

        stop_button = tk.Button(self.button_frame, text="Stoppen", fg="white", bg="red",
                                  font=("Helvetica", 12), width=30, height=5, command=self.root.destroy)
